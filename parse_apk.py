...
try:
    ...
    # Get all intent actions from the manifest
    manifest_xml = apk.get_android_manifest_xml()
    # It returns an lxml or xml.etree ElementTree object
    actions = set()
    schemes = set()
    ...
    for a in sorted(actions):
        if a and ("moji" in a.lower() or "search" in a.lower() or "intent" in a.lower()):
            print("-", a)
